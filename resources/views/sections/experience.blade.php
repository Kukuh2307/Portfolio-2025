...
<section id="experience"
    class="relative py-24 px-4 bg-gradient-to-b from-slate-900 via-slate-800/40 to-slate-900 overflow-hidden">
    ...
    <div class="max-w-6xl mx-auto relative z-10">
        ...
        <div class="timeline relative">
            <!-- Vertical Line -->
            <div
                class="absolute left-1/2 transform -translate-x-1/2 w-px h-full bg-gradient-to-b from-cyan-400 via-blue-500 to-transparent hidden md:block animate-gradient-flow">
            </div>
                        ...
                        <div class="timeline-item flex flex-col md:flex-row md:w-full md:max-w-5xl relative">
                            ...
                            @if ($isEven)
                                <div class="md:w-1/2 md:pr-12 md:text-right">
                                    <div
                                        class="group glass-effect relative rounded-2xl p-6 border border-cyan-500/20 hover:border-cyan-400/60 transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_0_30px_-10px_rgba(6,182,212,0.5)]">
                                        <h3
                                            class="text-2xl font-bold text-cyan-400 mb-2 group-hover:text-cyan-300 transition-colors">
                                            {{ $exp['position'] }}</h3>
                                ...
                                <div class="hidden md:flex items-center justify-center w-4 mx-4 relative z-10">
                                    <div class="relative">
                                        ...
                                        <div
                                            class="w-4 h-4 bg-cyan-400 rounded-full border-4 border-slate-900 shadow-[0_0_20px_rgba(34,211,238,0.8)]">
                                        </div>
                                    </div>
                                </div>
                            ...
                            @else
                                ...
                                <div class="hidden md:flex items-center justify-center w-4 mx-4 relative z-10">
                                    <div class="relative">
                                        ...
                                        <div
                                            class="w-4 h-4 bg-blue-500 rounded-full border-4 border-slate-900 shadow-[0_0_20px_rgba(59,130,246,0.8)]">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="md:w-1/2 md:pl-12 md:text-left">
                                    <div
                                        class="group glass-effect relative rounded-2xl p-6 border border-blue-500/20 hover:border-blue-400/60 transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_0_30px_-10px_rgba(59,130,246,0.5)]">
                                        <h3
                                            class="text-2xl font-bold text-blue-400 mb-2 group-hover:text-blue-300 transition-colors">
                                            {{ $exp['position'] }}</h3>
                                        <p class="text-gray-300 font-semibold">{{ $exp['company'] }}</p>
                                        <p class="text-sm text-gray-400 mb-4 italic">
                                            {{ \Carbon\Carbon::parse($exp['start_date'])->format('M Y') }} –
