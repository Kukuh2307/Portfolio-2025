<!-- ============================================================================
     ...
     ============================================================================ -->
<section id="achievements" class="py-20 px-4 bg-slate-900/50">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            @foreach ($achievements as $index => $achievement)
                <div class="glass-effect rounded-lg p-6 hover-lift border-l-4 border-accent" data-aos="fade-up"
                    data-aos-delay="{{ $index * 100 }}">
                    <div class="flex items-start">
                        <!-- Icon / Badge -->
                        <div
                            class="w-12 h-12 rounded-full bg-accent/20 flex items-center justify-center flex-shrink-0 mr-4">
                        ...
                        <div class="flex-1">
                            ...
                            @if ($achievement->link)
                                <a href="{{ $achievement->link }}" 
                                   target="_blank" 
                                   class="inline-block text-accent hover:underline text-sm font-semibold">
                                    Lihat Detail →
                                </a>
                            @endif --}}
                        </div>
