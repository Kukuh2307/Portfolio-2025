    ...
    <div class="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative">
        <!-- Text Content -->
        <div class="lg:col-span-7 text-center lg:text-left z-10" data-aos="fade-right">
            
            <h1 class="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight ">
                <span class="block mb-2 text-white">{{ $developer_name }}</span>
                <span class="text-4xl bg-gradient-to-r from-accent to-blue-500 bg-clip-text text-transparent">{{ $developer_title }}</span>
            </h1>
            ...
            <div class="flex flex-wrap gap-3 justify-center lg:justify-start mb-8">
                <span class="hover-lift px-3 py-2 bg-slate-800/50 border border-slate-700 rounded-lg text-sm text-gray-300">PHP</span>
                <span class="hover-lift px-3 py-2 bg-slate-800/50 border border-slate-700 rounded-lg text-sm text-gray-300">JavaScript</span>
                <span class="hover-lift px-3 py-2 bg-slate-800/50 border border-slate-700 rounded-lg text-sm text-gray-300">Laravel</span>
                <span class="hover-lift px-3 py-2 bg-slate-800/50 border border-slate-700 rounded-lg text-sm text-gray-300">React</span>
                <span class="hover-lift px-3 py-2 bg-slate-800/50 border border-slate-700 rounded-lg text-sm text-gray-300">Tailwind CSS</span>
            </div>
            ...
            <div class="flex justify-center lg:justify-start gap-4 mt-8">
                <a href="#" class="hover-lift p-3 bg-slate-800/50 border border-slate-700 rounded-lg text-gray-400 hover:text-accent hover:border-accent/50 transition-all">
