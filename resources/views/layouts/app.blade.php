...
$experiences = [
    [
        ...
        'description' => ['Developed responsive web applications using PHP and Laravel', 'Collaborated with design team to implement UI/UX mockups', 'Fixed bugs and optimized database queries for better performance'],
    ],
    [
        'position' => 'Frontend Developer',
        'company' => 'Digital Agency XYZ',
        'duration' => 'Sep 2023 - Dec 2023',
        'description' => ['Built interactive interfaces using vanilla JavaScript and Tailwind CSS', 'Implemented RESTful API integration for frontend applications', 'Participated in Agile/Scrum development process'],
    ],
    [
        'position' => 'Junior Developer',
        'company' => 'Startup Hub Jakarta',
        'duration' => 'Mar 2023 - Aug 2023',
        'description' => ['Created static websites and landing pages using HTML, CSS, and JavaScript', 'Maintained and updated existing web applications', 'Assisted senior developers in code review and documentation'],
    ],
];
...
// Hard Skills Data
$hard_skills = [['name' => 'PHP', 'category' => 'back-end'], ['name' => 'Laravel', 'category' => 'back-end'], ['name' => 'MySQL', 'category' => 'back-end'], ['name' => 'HTML5', 'category' => 'front-end'], ['name' => 'CSS3', 'category' => 'front-end'], ['name' => 'JavaScript', 'category' => 'front-end'], ['name' => 'Tailwind CSS', 'category' => 'front-end'], ['name' => 'React', 'category' => 'front-end'], ['name' => 'Git & GitHub', 'category' => 'devops'], ['name' => 'Docker', 'category' => 'devops'], ['name' => 'AWS', 'category' => 'devops'], ['name' => 'REST API', 'category' => 'back-end']];

// Soft Skills Data
$soft_skills = ['Problem Solving', 'Communication', 'Team Collaboration', 'Critical Thinking', 'Time Management', 'Adaptability'];
...
// Social Links
$social_links = [['name' => 'LinkedIn', 'url' => 'https://linkedin.com/in/budisantoso', 'icon' => 'linkedin'], ['name' => 'GitHub', 'url' => 'https://github.com/budisantoso', 'icon' => 'github'], ['name' => 'Email', 'url' => 'mailto:budi@example.com', 'icon' => 'mail']];
